...
<body>
    <center><h1 style="font-family:playfair ; color:#ff0000; font-size:67px ; font-weight:bolder">CAMEL (FATTENING)L</h1></center>
...
$sel=mysqli_query($con,"SELECT * from soft WHERE `Animal`='Camel' AND `Purpose`='Fattening'");
