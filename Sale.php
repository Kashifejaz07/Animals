...
if(isset($_POST['submit']) ) 
      ...
      $query=("INSERT INTO `sale`(`s_id`, `Animal`, `Cost`, `soldby`, `weight`, `date`, `fare`) VALUES ('$id','$Animal','$cost','$soldby','$weight','$date','$fare')");
...
<body>
	...
	<h3 class="sub-heading-agileits" ">LIVE STORE</h3>
		<form action="#" method="post"  enctype="multipart/form-data">
			<h3 class="sub-heading-agileits">SALE</h3>
			
				<div class="field-agileinfo-spc form-w3-agile-text2">
				<input type="text" class="form-control" name="id"  placeholder="Enter Serial Number" style="background: black;width:20%;">
		...
		<form action="#" method="post"  enctype="multipart/form-data">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input class="field" name="id" required="required" value="<?php if(!empty($i1)){ echo "$i1";}  ?>" type="text" placeholder="Purchase Id" />
				</div>
			<div class="field-agileinfo-spc form-w3-agile-text2">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					...
					<input class="field" name="cost" required="required" type="text" placeholder="Cost Price" />
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					...
					<input class="field" name="weight" required="required" type="text" placeholder="Enter Weight" />
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
			
					<input class="field" name="date" required="required" type="date" placeholder="Due" />
				</div>
			</div>
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
				
					<input class="field" name="fare" required="required" type="text" placeholder="Enter Fare" />
				</div>
...
<?php
		    ...
		    $sel=mysqli_query($con,"SELECT * FROM sale");
