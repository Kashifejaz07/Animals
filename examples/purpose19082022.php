...
$con = mysqli_connect("localhost","root","","live_stock_db");
...
<body>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="http://khaitonline.com/Bakra/" class="simple-text">
                        HOME
                    </a>
                </div>
                  <ul class="nav">
                   ...
                   <li class="nav-item active">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="./vacination_calender.php">
                            <i class="nc-icon nc-notes"></i>
                            <p>Vaccination Calendar</p>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">PURPOSE</h3>
            <div class="main-flex-w3ls-sectns">
             
                <div class="field-agileinfo-spc form-w3-agile-text1">
                    <LABEL>PURPOSE</LABEL>
                    <input class="field" name="purpose" required="required" type="text" placeholder="PURPOSE" />
                </div>
                <div class="field-agileinfo-spc form-w3-agile-text1">
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            ...
                            <?php
                            $sel=mysqli_query($con,"SELECT * from purpose");
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='purpose_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
