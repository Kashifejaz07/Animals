...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">CATEGORY</h3>
            <div class="main-flex-w3ls-sectns">
             
                <div class="field-agileinfo-spc form-w3-agile-text1">
                    <LABEL>CATEGORY</LABEL>
                    <input class="field" name="category" required="required" value="<?php echo $rate ?>"  type="text" placeholder="CATEGORY" />
                </div>
                <div class="field-agileinfo-spc form-w3-agile-text1">
                          ...
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='category_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
