...
<body>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="http://www.sealsassociates.com/animals/" class="simple-text">
                        HOME
                    </a>
                </div>
                 <ul class="nav">
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">Total</h3>
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain table-plain-bg">
                                ...
                                <div class="card-body table-full-width table-responsive" style="background: black;opacity: 0.8;color: white;">
