...
if(isset($_POST['submit']) )
        ...
        $sql="insert into add_animals(status)
	  Values('$status')"; 
...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">STATUS</h3>
            <div class="main-flex-w3ls-sectns">
             
                <div class="field-agileinfo-spc form-w3-agile-text1">
                    <LABEL>STATUS</LABEL>
                    <input class="field" name="status" required="required" value="<?php echo $rate ?>" type="text" placeholder="STATUS..." />
                </div>
                <div class="field-agileinfo-spc form-w3-agile-text1">
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            ...
                            <?php
                            $sel=mysqli_query($con,"SELECT * from status_dashbord");
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                      <a href='delete/delete_status.php?id=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
