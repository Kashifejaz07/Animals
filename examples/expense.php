...
if(isset($_POST['submit']) )
        ...
        $sql="insert into expense(feed,doctor)
	  Values('$feed','$doctor')"; 
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            ...
            <div class="main-flex-w3ls-sectns">
                <div class="field-agileinfo-spc form-w3-agile-text2">
                   ...
                   <input class="field" name="feed" required="required" value="<?php echo $rate ?>" type="text" placeholder="Expense">
                </div>
                <!--<div class="field-agileinfo-spc form-w3-agile-text2">
                    <label>DOCTOR</label>
                          ...
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='expense_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
