        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            ...
            <div class="main-flex-w3ls-sectns">
                ...
                <div class="field-agileinfo-spc form-w3-agile-text2">
                    <label>ANIMAL</label>
                   <input class="field" name="animal" required="required" value="<?php echo $rate ?>" type="text" placeholder="Animal">
                </div>
              <div class="field-agileinfo-spc form-w3-agile-text2">
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain table-plain-bg">
                                ...
                                <div class="card-body table-full-width table-responsive" style="background: black;opacity: 0.8;color: white;width: 63%; margin: auto;">
                          ...
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='animal_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
