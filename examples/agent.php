...
if(isset($_POST['submit']) )
        ...
        $sql="insert into agent_commission(agent_commission)
...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">AGENT COMMISSION</h3>
             <div class="main-flex-w3ls-sectns">
             
                <div class="field-agileinfo-spc form-w3-agile-text1">
                    <LABEL>AGENT COMMISSION</LABEL>
                    <input class="field" name="agent_commission" required="required" value="<?php echo $rate ?>" type="text" placeholder="COMMISSION" />
                </div>
                <div class="field-agileinfo-spc form-w3-agile-text1">
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            ...
                            <?php
                            $sel=mysqli_query($con,"SELECT * from agent_commission");
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    <td>$row[0]</td>
                                    <td>$row[1]</td>
                                    <td><a href='delete.php?aid=$row[0]' ><i class='fa fa-edit' style='font-size:30px;color:white'></i></a></td>
                                    <td><a href='agent_delete.php?aid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
