...
if(isset($_POST['submit']) )
        ...
        $sql="insert into vacination(feed,doctor)
	  Values('$feed','$doctor')"; 
...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">EXPENSE</h3>
            <div class="main-flex-w3ls-sectns">
				...
				<label> DISEASE</label>
					...
					$sel=mysqli_query($con,"SELECT * FROM ``");
...
?>
             ...
             <div class="main-flex-w3ls-sectns">
                <!--<div class="field-agileinfo-spc form-w3-agile-text2">
				<label> Week</label>
					<select class="form-control" name="week" required="required" value="<?php echo $rate ?>"> 
                ...
                <div class="field-agileinfo-spc form-w3-agile-text2">
                  ...
                  <input class="field" name="feed" required="required" value="<?php echo $rate ?>" type="text"  placeholder="feed">
                </div>
             <div class="field-agileinfo-spc form-w3-agile-text2">
                    <label>Doctor</label>
                    
                  <input class="field" name="doctor" required="required" value="<?php echo $rate ?>" type="text"  placeholder="doctor">
                </div>
