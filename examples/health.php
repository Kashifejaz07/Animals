...
if(isset($_POST['submit']) )
        ...
        $sql="insert into health_status(health_status)
...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">HEALTH STATUS</h3>
            <div class="main-flex-w3ls-sectns">
             
                <div class="field-agileinfo-spc form-w3-agile-text1">
                    <LABEL>HEALTH STATUS</LABEL>
                    <input class="field" name="health_status" required="required" value="<?php echo $rate ?>" type="text" placeholder="HEALTH STATUS" />
                </div>
                <div class="field-agileinfo-spc form-w3-agile-text1">
        ...
        <!--// Form starts here -->
                        ...
                        <div class="col-md-12">
                            ...
                            <?php
                            $sel=mysqli_query($con,"SELECT * from health_status");
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='health_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
