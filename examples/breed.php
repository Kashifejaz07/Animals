...
if(isset($_POST['submit']) )
        ...
        $sql="insert into breed(Animal,breed)
	  Values('$Animal','$breed')"; 
...
<body>
    ...
    -->
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            <h3 class="sub-heading-agileits">BREED</h3>
...
?>
                ...
                <div class="field-agileinfo-spc form-w3-agile-text2">
                    <label>BREED</label>
                   <input class="field" name="breed" required="required" value="<?php echo $rate ?>" type="text" placeholder="BREED">
                </div>
              <div class="field-agileinfo-spc form-w3-agile-text2">
                          ...
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='breed_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
