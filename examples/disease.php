...
if(isset($_POST['submit']) )
        ...
        $sql="insert into disease(disease)
	  Values('$disease')"; 
        ...
        <form action="#" method="post"  enctype="multipart/form-data">
            ...
            <div class="main-flex-w3ls-sectns">
                <div class="field-agileinfo-spc form-w3-agile-text2">
                    <label>DISEASE</label>
                   <input class="field" name="disease" required="required" type="text" placeholder="Disease">
                </div>
              <div class="field-agileinfo-spc form-w3-agile-text2">
                          ...
                          while($row=mysqli_fetch_array($sel))
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href='disease_delete.php?pid=$row[0]'><i class='fa fa-trash' style='font-size:30px;color:white'></i></a></td>
