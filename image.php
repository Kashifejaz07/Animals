...
if(isset($_POST['submit']) )
    ...
    $sql="insert into image(id,image) Values('$id','$filename','$image')"; 
     	$con->query($sql);
	...
	<div class="register-form-w3layouts">
		...
		<form action="" method="post">
			...
			<div style="text-align:center;">		
				...
				<label>Select Photo <?php echo $rate ?></label>
                  ...
                  <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="myTable">
							...
							<?php															
                                ...
                                <tr>
                                    ...
                                    <td><img src="upload/<?php echo $rows['image']; ?>" /></td>
									
									<td> 
									    <a href='delete/delete_image.php?id=<?php echo $rows['id'];?>' onclick="return confirm('Are you sure you want to delete this item?');"><i class='fa fa-trash' style='font-size:30px;color:white;float:;'></i></a>
									</td>                                   
                                </tr>
