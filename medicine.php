...
if(isset($_POST['submit']) ) 
    ...
    $sql="insert into medicine(id,medicine_cost,date)
	  Values('$id','$medicine_cost','$date')"; 
...
<?php
		...
		$rows=$results->fetch_assoc();	 
 		$medicine_cost=$rows['medicine_cost'];
		$date=$rows['date'];
...
<body>
	...
	<div class="register-form-w3layouts">
		...
		<h3 class="sub-heading-agileits" style="padding-right: 33rem;" ><input class="field" name="id" type="text" placeholder="" value="<?php echo $_GET['id'];?>" readonly/></h3>
...
<div class="field-agileinfo-spc form-w3-agile-text1">
                            ...
                            <input class="field" name="medicine_cost" required="required" value="<?php echo $medicine_cost;?>" type="number"
                  ...
                  <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="myTable">
							...
							<?php															
                                ...
                                <tr>
									...
									<td><?php echo $rows['medicine_cost']; ?></td>
									
									<td> 
									    <a href='delete/delete_medicine.php?id=<?php echo $rows['id'];?>' onclick="return confirm('Are you sure you want to delete this item?');"><i class='fa fa-trash' style='font-size:30px;color:white;float:;'></i></a>
									</td>
