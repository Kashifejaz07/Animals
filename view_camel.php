...
<div class="body">
                  ...
                  <table class="table table-bordered table-striped table-hover " id="myTable">
							...
							<?php															
								...
								$sql="select * From add_animals WHERE Animal='camel'";
                                ...
                                <tr>
									...
									<td><a href='edit_animal.php?id=<?php echo $rows['id'];?>'><i class='fa fa-edit' style='font-size:30px;color:white;float:left;'></i></a> 
									    <a href='delete/delete_animal.php?id=<?php echo $rows['id'];?>' onclick="return confirm('Are you sure you want to delete this item?');"><i class='fa fa-trash' style='font-size:30px;color:white;float:left;'></i></a>
									</td>                                   
                                </tr>
