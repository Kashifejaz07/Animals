...
<body>
	...
	<div class="register-form-w3layouts">
		<!-- Form starts here -->
		<form action="update/update_animal_registration.php?id=<?php echo $_GET['id'];?>" method="post"  enctype="multipart/form-data">
			<h3 class="sub-heading-agileits">EDIT PROFILE</h3>
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					...
					<select class="form-control" name="breed" value="<?php echo $breed;?>">
...
?>
				...
				<label> Health status </label>
					<select class="form-control" name="health_status" value="<?php echo $health_status;?>">
