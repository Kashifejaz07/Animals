...
<?php
		...
		$id=$_GET['id'];
		$sql="select * From feed_in where id='$id'";
	...
	<div id=" content">
        <div class="content-1">
            <div class="register-form-w3layouts">
                ...
                <!-- Form starts here -->
                <form action="update/update_feed_in.php?id=<?php echo $_GET['id'];?>" method="post">
                    <h3 class="sub-heading-agileits">Feed In</h3>
...
<br></br>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table id="myTable">
                ...
                <!--<center><h1 style="font-family:monotype corsiva ; color:#ffffff; font-size:55px ; font-weight:bolder"><a href="">History</a></h1></center>-->
