...
<?php
		$id=$_GET['id'];
		$sql="select * From expense_tab where id='$id'";
		$results = $con->query($sql);	
		$rows=$results->fetch_assoc();	 
 		$create_date=$rows['create_date'];
		$anial_id=$rows['animal_id'];
		$medicine_expense=$rows['medicine_expense'];
		$misc_expense=$rows['misc_expense'];
?>	
<body>
            ...
            <div class="register-form-w3layouts">
                ...
                <form action="#" method="" enctype="">
                    ...
                    <div class="field-agileinfo-spc form-w3-agile-text1">
                            <label>Medicine Expense</label>
                            <input class="field" name="medicine_expense" required="required" type="number"
                                placeholder="" value="<?php echo $feed_quantity;?>" />
                        </div>

                        <div class="field-agileinfo-spc form-w3-agile-text1">
                            <label>Misc Expense</label>
                            <input class="field" name="misc_expense" required="required" type="number"
                                placeholder="" value"<?php echo $feed_quantity;?>" />
                        </div>
