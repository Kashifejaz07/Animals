...
if(isset($_POST['submit']) )
    ...
    $sql="insert into herd(create_date,Purpose,Animal,image) Values('$create_date','$Purpose','$Animal','$filename')";
	...
	<div class="register-form-w3layouts">
		...
		<form action="" method="post"  enctype="multipart/form-data">
			...
			<div style="text-align:center;">		
			    <div class="main-flex-w3ls-sectns" style="padding-right: 10rem;
    padding-left: 2rem;">
                     <input type="date" name="create_date" value="<?php echo (new DateTime())->format('Y-m-d'); ?>" class="form-control">
                </div>
                
                <div class="field-agileinfo-spc form-w3-agile-text2" style="margin-right: 7rem;
    margin-left: 1.5rem;">
				        	<label> Purpose </label>
				...
				<div class="field-agileinfo-spc form-w3-agile-text2" style="margin-left: 1rem;
    margin-right: 6.5rem;
}">
				<label> Animal</label>
