...
if(isset($_POST['submit']) ) 
     ...
     $query=("INSERT INTO `weight`(`S:NO`,`weight`,`date`) VALUES ('$id','$weight','$date')");
		...
		<form action="#" method="post"  enctype="multipart/form-data">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input class="field" name="id" required="required" value="<?php if(!empty($idd)){ echo "$idd";}  ?>" type="text" placeholder="S:NO" readonly />
				</div>
...
<?php
		    ...
		    $sel=mysqli_query($con,"SELECT * FROM `soft` WHERE `S:NO`='$idd'");
