...
$q=$quantity.$quantity1;



if(isset($_POST['submit']) ) 

       $query=("INSERT INTO `birth`(`b_animal`, `b_tag`, `b_dob`, `b_gender`, `b_qty`) VALUES ('$animal','$tag','$dob','$radio','$q')");
...
<body>
	...
	<h3 class="sub-heading-agileits" ">LIVE STORE</h3>
		<form action="#" method="post"  enctype="multipart/form-data">
			<h3 class="sub-heading-agileits">BIRTH</h3>
			
				<div class="field-agileinfo-spc form-w3-agile-text2">
			<input type="text" name="ValueToSearch" placeholder="Value To Search"><br><br>
<input type="submit" name="search" class="btn btn-primary btn-md" value="Filter"><br><br>
...
<div class="field-agileinfo-spc form-w3-agile-text1">
			<label>Date of Birth</label>
					<input class="field" name="dob" required="required" type="date" placeholder="Cost Price" />
				</div>
			</div>
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					...
					<input class="field" name="radio"  type="radio" placeholder="Enter Weight" value="Male" /><label>Male</label>
						<input class="field" name="quantity"  type="number" placeholder="Quantity"  style="width:35%"/>
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
			
				<input class="field" name="radio"  type="radio" placeholder="Enter Weight" value="female" /><label>Female</label>
						<input class="field" name="quantity1"  type="number" placeholder="Quantity"  style="width:35%"/>
				</div>
			</div>
...
<?php
		    ...
		    $sel=mysqli_query($con,"SELECT * FROM `birth`");
